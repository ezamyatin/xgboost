...
public class XGBoost {
  ...
  /**
    * load model from modelPath
    *
    * @param modelJson booster modelPath (model generated by booster.saveModel)
    * @throws XGBoostError native error
    */
  public static Booster loadModelJson(String modelJson)
    throws XGBoostError {
    return Booster.loadModelJson(modelJson);
  }
